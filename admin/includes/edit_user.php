...
//section that update users' record in the database
   $update_users = "UPDATE users SET user_firstname = '$user_firstname ' , user_lastname = '$user_lastname' , username = '$username' ,  user_email = '$user_email' , user_password = '$user_password',user_role = '$user_role' WHERE user_id = '$user_id'";
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<button type="submit" name="edit_user" class="btn btn-primary" value=""> Update user profile &nbsp;<span class="glyphicon glyphicon-chevron-right"> </span></button> 
	</div>
</form>