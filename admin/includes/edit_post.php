...
if (isset($_POST['update_post'])) {
    ...
    echo  '<div class="alert alert-success">Post Updated successfully: <a href="../post.php?post_id='.$post .'">View Post</a>  or <a href="posts.php?post_id='.$post .'">Edit more posts</a></div>';
